...
<sec:authorize access="hasRole('USER')">
    ...
    <div class="section">
        ...
        <button class="button raised bg-red-500 color-white" id="plusMinus" value="plusMinus"
                onclick="calc(this)" disabled>+/-</button>
        <button  class="button raised bg-green-500 color-white" id="equal" name="equal" value="equal"
                 onclick="calc(this)">=</button>
